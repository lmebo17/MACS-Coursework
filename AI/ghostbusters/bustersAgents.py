...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for belief in livingGhostPositionDistributions:
            most_likely_positions.append(belief.argMax())
        ...
        for action in legal:
            ...
            action_distance = float('inf')

            for ghostPos in most_likely_positions:
                distance_to_ghost = self.distancer.getDistance(successorPos, ghostPos)
                action_distance = min(action_distance, distance_to_ghost)
