...
from n2t.infra import AsmProgram, HackProgram, VmProgram
from n2t.infra.execute import ExecuteProgram
...
def run_simulator(
    file: str,
    cycles: int = Option(100000, "--cycles", help="CYCLES"),
) -> None:
    echo(f"Executing {file}")
    ExecuteProgram.load_from(file).execute(cycles)
    echo("Done!")
