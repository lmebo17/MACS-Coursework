...
public class FacePamphletProfile implements FacePamphletConstants {
	 ...
	 * this profile (and the name is to the list). The method returns false if the
	 * given friend name was already in the list of friends for this profile (in
	...
	public String toString() {
		...
		return "" + profileName + " Status:" + profileStatus + " Friends- " +  friendsList;
	}
